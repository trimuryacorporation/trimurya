        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[...new Set([
              ...
              '100% transparent monthly reporting'
            ])].map((outcome, index) => (
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-12 relative">
            ...
            <div className="space-y-10">
              ...
              {[
                { step: '02', title: 'Strategy & Planning', copy: 'Define multi-channel marketing strategy, audience personas, content calendars, and budget allocation aligned with business goals.' },
                { step: '03', title: 'Campaign Execution', copy: 'Launch SEO, PPC, social, email, and content campaigns with creative assets, ad copy, and targeting setups.' },
                { step: '04', title: 'Optimization & Testing', copy: 'Run A/B tests, refine targeting, improve landing pages, and optimize bids to maximize ROI and conversion rates.' },
                { step: '05', title: 'Reporting & Scaling', copy: 'Deliver transparent dashboards, analyze attribution, and scale winning channels while phasing out underperformers.' }
              ].map((phase, index) => (
