        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[...new Set([
              ...
              '60% lower turnover within 1 year',
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {service.benefits.map((benefit, index) => {
              const BenefitIcon = resolveIcon(benefit.icon) || FiUsers;
              return (
            ...
            {[
              { title: 'Rigorous Screening', copy: 'Multi-stage assessments including technical, cultural, and behavioral evaluations to ensure only the best candidates move forward.', icon: FiUsers },
              { title: 'Employer Branding', copy: 'Strengthen your EVP and digital presence to attract top talent in competitive markets with targeted positioning.', icon: FiBriefcase },
              { title: 'Diversity & Inclusion', copy: 'Bias-free hiring processes and inclusive policies that build diverse teams and drive innovation.', icon: FiHeart },
              { title: 'HR Analytics & Insights', copy: 'Data-driven workforce planning, turnover analysis, and performance metrics to inform strategic decisions.', icon: FiTrendingUp }
            ].map((benefit, index) => {
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-12 relative">
            ...
            <div className="space-y-10">
              ...
              {[
                { step: '02', title: 'Employer Branding & EVP', copy: 'Strengthen your employer value proposition and digital presence to attract the right candidates in competitive talent markets.' },
                { step: '03', title: 'Sourcing & Screening', copy: 'Leverage AI-driven sourcing, rigorous assessments, and structured interviews to shortlist high-quality candidates.' },
                { step: '04', title: 'Onboarding & Integration', copy: 'Design seamless onboarding experiences, orientation programs, and early engagement to reduce time-to-productivity.' },
                { step: '05', title: 'Retention & Workforce Analytics', copy: 'Monitor engagement, turnover, and performance with data-driven insights to continuously improve your HR strategy.' }
              ].map((phase, index) => (
