        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-12 relative">
            ...
            <div className="space-y-10">
              ...
              {[
                { step: '02', title: 'Design & Prototyping', copy: 'Create wireframes, visual designs, and interactive prototypes aligned with your brand and user experience goals.' },
                { step: '03', title: 'Development & Integration', copy: 'Build responsive frontends and robust backends with clean code, CMS integration, and third-party APIs.' },
                { step: '04', title: 'Testing & QA', copy: 'Perform functional, performance, accessibility, and cross-browser testing to ensure a flawless launch.' },
                { step: '05', title: 'Deployment & Optimization', copy: 'Launch with CI/CD pipelines, monitor Core Web Vitals, and iterate based on analytics and user feedback.' }
              ].map((phase, index) => (
